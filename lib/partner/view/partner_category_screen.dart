...
import 'package:all_of_them/partner/component/partner_vertical_item_list.dart';
...
class PartnerCategoryScreen extends ConsumerWidget {
  static String get routeName => 'partner_category';

  const PartnerCategoryScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final partners = ref.watch(partnerRandomByCategoryProvider);
    final selectedButtonLabel = ref.watch(selectedPartnerCategoryProvider);
    ...
    return DefaultLayout(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomWrap(
                        buttons: PartnerCategoryType.values
                            .map((e) => CustomWrapButtonModel(
                                  title: e.label,
                                  onTap: () {
                                    ref
                                        .read(selectedPartnerCategoryProvider
                                            .notifier)
                                        .state = e;
                                  },
                                ))
      ...
      child: PartnerVerticalItemList(partners: partners),
    );
  }
}
